...
There's an external factor to the perception of any quality. If a bearer has a surface, and there is another entity "light" around, then the bearer can exhibit the quality "color"?
...
* C) Or we could let time in the door, allowing age to be a quality, a measure of interval, whose semantic bookends are not themselves qualities.*
